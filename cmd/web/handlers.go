...
func (app *application) home(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// it can acces its fields, including the error logger. We'll write the log
...
// Change the signature of the gistView handler so it is defined as a method against
// *application
...
// Change the signature of the gistCreate handler so it is defined as a method against
// *application
